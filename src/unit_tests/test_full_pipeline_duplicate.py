...
async def test_full_pipeline_duplicate():
    ...
    try:
        ...
        # Check if facts were stored in Excel after first processing
        print("\nVerifying facts in Excel after first document...")
        ...
        # Check if chunks were stored in Excel
        ...
        # Check if document hash is in chunks
        print("\nChecking for document hash in chunks...")
        if os.path.exists("data/all_chunks.xlsx"):
            chunks_df = pd.read_excel("data/all_chunks.xlsx")
