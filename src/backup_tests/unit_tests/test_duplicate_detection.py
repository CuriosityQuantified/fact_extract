...
async def test_duplicate_detection():
    ...
    try:
        ...
        # Check Excel for duplicate detection
        print("\nVerifying chunk duplicate detection in Excel...")
        ...
        # Check Excel for fact duplicate detection
        print("\nVerifying fact duplicate detection in Excel...")
